...
AJAX_ALLOW_FK_CREATION_MODELS = ['comment', 'list'] # List of model names (lowercase) for which creation of new related objects is allowed in ForeignKey fields
AJAX_ALLOW_RELATED_CREATION_MODELS = ['tag', 'visits', 'list', 'list-location', 'description', 'link'] # List of model names (lowercase) for witch creation of new related objects is allowed in Related fields (ManyToMany, OneToOne)
